...
## 🚀 Features
- Add doctors with specialization and timed availability
- Add patients with priority and required specialization
- Automatic doctor assignment using a greedy strategy
- Dashboard to view doctor load
- Report generation
...
## 📚 Author
•	Mohammad Saheel Quazi 	A7-B2-23
•	Syed Umar Ali 			   A7-B2-22
•	Ashraf Sheikh 			   A7-B2-29
